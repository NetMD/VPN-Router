...
Work begins with Phase 1. Phase 2 starts after the launcher can produce and open a
local dogfooding artifact. Streaming acceptance is then confirmed by the owner during
Phase 3, while implementation work continues on lifecycle and security hardening.
